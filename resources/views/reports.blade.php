...
<main class="pt-20 min-h-screen pb-16 py-6 pl-5 pr-5 sm:pl-6 sm:pr-6 lg:pl-[calc(16rem+1.5rem)] lg:pr-8">
                        ...
                        <tbody class="divide-y divide-pink-50/50">
                            @foreach ($topProducts as $i => $product)
                                @php
                                    ...
                                    $iconBgPalette = ['bg-pink-100','bg-purple-100','bg-blue-100','bg-primary-fixed'];
                                    $iconBg = $iconBgPalette[$i % 4];
                                @endphp
                                    ...
                                    <td class="px-8 py-6">
                                        <div class="flex items-center gap-4">
                                            <div class="w-12 h-12 rounded-2xl {{ $iconBg }} flex items-center justify-center shrink-0">
                                                <span class="material-symbols-outlined text-pink-600" style="font-variation-settings:'FILL' 1;">lunch_dining</span>
                                            </div>
                                            <div>
...
<nav class="md:hidden fixed bottom-0 w-full bg-white/90 backdrop-blur-lg border-t border-pink-100 px-6 py-3 flex justify-around items-center z-50">
    ...
    <a href="{{ route('reports.index') }}" class="flex flex-col items-center gap-1 text-pink-600">
        <span class="material-symbols-outlined" style="font-variation-settings:'FILL' 1;">analytics</span>
